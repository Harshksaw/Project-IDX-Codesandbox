    ...
    <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
      <View style={styles.infoSection}>
        ...
        <View style={styles.infoRow}>
          ...
          {(() => {
            const isPastEvent = userOrder?.event.status === 'past' || userOrder?.event.status === 'cancelled';
            const isRefunded = userOrder?.orderStatus === 'canceled' || userOrder?.orderStatus === 'refunded' || userOrder?.orderStatus === 'declined';
            ...
            if (isPastEvent) {
              ...
              if (userOrder?.orderStatus === 'confirmed') {
                return (
                  <View style={styles.statusPill}>
              ...
              } else if (userOrder?.orderStatus === 'pending') {
                return (
                  <View style={styles.statusPill}>
